...
interface ListCourierPackageItemDeliveredUseCaseRequest {
  page: number
  creatorId: string
  courierId: string
}
...
@Injectable()
export class ListCourierPackageItemDeliveredUseCase {
  constructor(
  ...
  async execute({
    ...
    courierId,
    page,
  }: ListCourierPackageItemDeliveredUseCaseRequest): Promise<ListCourierPackageItemDeliveredUseCaseResponse> {
    ...
    const courierPackageItemsDelivered =
