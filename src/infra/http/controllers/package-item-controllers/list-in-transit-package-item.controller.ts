...
@Controller('/package_item/list/in_transit')
export class ListInTransitPackageItemsToAdminController {
  constructor(
    private listInTransitPackageItemsToAdmin: ListInTransitPackageItemToAdminUseCase,
  ) {}
  ...
  async handle(
    ...
    const result = await this.listInTransitPackageItemsToAdmin.execute({
      creatorId: user.sub,
      page,
    })
