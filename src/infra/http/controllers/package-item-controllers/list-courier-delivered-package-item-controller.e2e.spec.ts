...
describe('list delivered package item to courier tests (e2e)', () => {
  ...
  test('[get]/package_item/:courierId/list/delivered', async () => {
    ...
    const url = `/package_item/${courier.id.toString()}/list/delivered`
