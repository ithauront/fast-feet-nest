...
@Controller('/package_item/list/awaiting_pickup')
export class ListAwaitingPickupPackageItemsToAdminController {
  constructor(
    private listAwaitingPickupPackageItemsToAdmin: ListAwaitingPickupPackageItemToAdminUseCase,
  ) {}
  ...
  async handle(
    ...
    const result = await this.listAwaitingPickupPackageItemsToAdmin.execute({
      creatorId: user.sub,
      page,
    })
