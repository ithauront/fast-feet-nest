...
@Controller('/package_item/list/delivered')
export class ListDeliveredPackageItemsToAdminController {
  constructor(
    private listDeliveredPackageItemsToAdmin: ListDeliveredPackageItemToAdminUseCase,
  ) {}
  ...
  async handle(
    ...
    const result = await this.listDeliveredPackageItemsToAdmin.execute({
      creatorId: user.sub,
      page,
    })
