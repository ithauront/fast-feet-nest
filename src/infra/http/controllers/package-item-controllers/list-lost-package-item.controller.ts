...
@Controller('/package_item/list/lost')
export class ListLostPackageItemsToAdminController {
  constructor(
    private listLostPackageItemsToAdmin: ListLostPackageItemToAdminUseCase,
  ) {}
  ...
  async handle(
    ...
    const result = await this.listLostPackageItemsToAdmin.execute({
      creatorId: user.sub,
      page,
    })
