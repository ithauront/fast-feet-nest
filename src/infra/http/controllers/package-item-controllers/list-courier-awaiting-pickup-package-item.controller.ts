...
@Controller('/package_item/:courierId/list/awaiting_pickup')
export class ListAwaitingPickupCourierPackageItemController {
  constructor(
    private listCourierAwaitingPickupPackageItem: ListCourierPackageItemAwaitingPickupUseCase,
  ) {}
  ...
  async handle(
    ...
    const result = await this.listCourierAwaitingPickupPackageItem.execute({
      creatorId: user.sub,
      page,
      courierId,
    })
