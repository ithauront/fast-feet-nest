...
type ListAwaitingPickupPackageItemToAdminUseCaseResponse = Either<AuthorizationError, {
    packageItems: PackageItemWithDetails[];
}>;
export declare class ListAwaitingPickupPackageItemToAdminUseCase {
    ...
    execute({ creatorId, page, }: ListAwaitingPickupPackageItemToAdminUseCaseRequest): Promise<ListAwaitingPickupPackageItemToAdminUseCaseResponse>;
}
export {};
