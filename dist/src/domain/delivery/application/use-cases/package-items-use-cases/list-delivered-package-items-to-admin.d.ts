...
type ListDeliveredPackageItemToAdminUseCaseResponse = Either<AuthorizationError, {
    packageItems: PackageItemWithDetails[];
}>;
export declare class ListDeliveredPackageItemToAdminUseCase {
    ...
    execute({ creatorId, page, }: ListDeliveredPackageItemToAdminUseCaseRequest): Promise<ListDeliveredPackageItemToAdminUseCaseResponse>;
}
export {};
