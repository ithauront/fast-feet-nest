...
type ListCourierPackageItemDeliveredUseCaseResponse = Either<AuthorizationError, {
    packageItems: PackageItemWithDetails[];
}>;
export declare class ListCourierPackageItemDeliveredUseCase {
    ...
    execute({ creatorId, courierId, page, }: ListCourierPackageItemDeliveredUseCaseRequest): Promise<ListCourierPackageItemDeliveredUseCaseResponse>;
}
export {};
