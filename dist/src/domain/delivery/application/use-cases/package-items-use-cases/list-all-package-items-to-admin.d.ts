...
type ListAllPackageItemsToAdminUseCaseResponse = Either<AuthorizationError, {
    packageItems: PackageItemWithDetails[];
}>;
export declare class ListAllPackageItemsToAdminUseCase {
    ...
    execute({ creatorId, page, }: ListAllPackageItemsToAdminUseCaseRequest): Promise<ListAllPackageItemsToAdminUseCaseResponse>;
}
export {};
